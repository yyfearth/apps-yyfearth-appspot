...
''')
    ...
    def get(self):
        ...
        # check
        if user:
            if ('|' + user.email() + '|') in '|yyfearth@gmail.com|admin@yyfearth.com|wilson@yyfearth.com|yyfearth@163.com|':
                # OK, dispatch
...
def main():
    application = webapp.WSGIApplication([('/proxy/admin', MainHandler)], debug=True)
